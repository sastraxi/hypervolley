...
public class Constants {
    ...
    public static final float CAMERA_FOV = 23f;
    ...
    public static final float GAME_ORTHOGRAPHIC_CAMERA_ZOOM = 0.36f;
    ...
    public static final float PLAYER_HEIGHT = 45f;
    public static final float PLAYER_RADIUS = 7.5f;
    ...
    public static final float BALL_RADIUS = 3.5f;
